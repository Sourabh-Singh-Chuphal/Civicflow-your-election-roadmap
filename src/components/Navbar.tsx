...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#FBFBFA]/90 backdrop-blur-md border-b border-[#1A1A1A]/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex justify-between h-24 items-center">
          ...
          <div className="hidden md:flex items-center gap-12 text-[11px] font-bold uppercase tracking-[0.2em] text-[#1A1A1A]/60">
            <a href="#process" className="hover:text-[#1A1A1A] transition-colors">Roadmap</a>
            <a href="#assistant" className="hover:text-[#1A1A1A] transition-colors">AI Intelligence</a>
            <a href="https://vote.gov" target="_blank" rel="noopener" className="hover:text-[#1A1A1A] transition-colors">Resources</a>
            <button 
